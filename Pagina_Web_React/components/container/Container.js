...
export default function Container(){
	...
	const [articulos, setArticulos] = useState([
		...
		{
			id: 2,
			titulo: "TITLE 2 VENTAS",
			descripcion:"Sure donr qui officia deserunt mollit anim id est laborum consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco."
