			...
			if(preg_match('/^[a-zA-Z0-9ñÑáéíóúÁÉÍÓÚ ]+$/', $_POST["nuevoNombre"]) &&
			   ...
			   preg_match('/^[a-zA-Z0-9]+$/', $_POST["nuevoPassword"])){
				...
				$datos = array("nombre" => $_POST["nuevoNombre"],
							   "paternoU" => $_POST["nuevoPaterno"],
							   "maternoU" => $_POST["nuevoMaterno"],
							   "sexoU" => $_POST["nuevoSexo"],
							   "nacimientoU" => $_POST["nuevoNacimiento"],
							   "ci" => $_POST["nuevoCi"],
							   "telefonoU" => $_POST["nuevoTelefono"],
							   "direccionU" => $_POST["nuevoDireccion"],
							   "celularU" => $_POST["nuevoCelular"],
							   "correoU" => $_POST["nuevoCorreo"],
			...
			if(preg_match('/^[a-zA-Z0-9ñÑáéíóúÁÉÍÓÚ ]+$/', $_POST["editarNombre"])  &&
			   ...
			   preg_match('/^[0-9 ]+$/', $_POST["editarCelular"])){
				...
				$datos = array("nombre" => $_POST["editarNombre"],
							   ...
							   "nacimientoU" => $_POST["editarNacimiento"],
							   "ci" => $_POST["editarCi"],
							   "telefonoU" => $_POST["editarTelefono"],
							   "direccionU" => $_POST["editarDireccion"],
							   "celularU" => $_POST["editarCelular"],
							   "correoU" => $_POST["editarCorreo"],
