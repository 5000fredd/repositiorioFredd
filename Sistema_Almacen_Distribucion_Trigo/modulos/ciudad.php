        ...
        <tbody>
           ...
           <?php
            ...
            foreach ($ciudad as $key => $value) {
              ...
              if($_SESSION["id"] == $value["idUsuario"]){
              ...
              echo '<tr>
                  ...
                  <td style="width:200px;">
                    ...
                    <div class="btn-group" style="width:200px;">
                      ...
                      <button class="btn btnImprimir" style="background-color:#34495E " token="'.$value["token"].'" title="ACTA DE ENTREGA PROVISIONAL">

                        <i class="fa fa-print" style="color:#FFFFFF"></i> 

                      </button>

                      <button class="btn btn-danger btnImprimirRecepcionD" token="'.$value["token"].'"
                      title="ACTA DE RECEPCIÓN DEFINITIVO">
                      ...
                      <button class="btn btn-warning btnEditarCiudad" data-toggle="modal" data-target="#modalEditarCiudad" idCiudad="'.$value["idCiudad"].'" title="BOTON PARA EDITAR EL REGISTRO"><i class="fa fa-pencil" style="color:#FFFFFF"></i></button> 
                  ...
                  <td>'.number_format($value["bruto"],3).'</td>
                  <td>'.number_format($value["tara"],3).'</td>
                  <td>'.number_format($value["netoK"],3).'</td>
                  <td>'.number_format($value["netoQ"],3).'</td>
                  <td>'.number_format($value["netoT"],3).'</td>
                  <td>'.$value["humedad"].'</td>
          ...
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="number" class="form-control input-lg netoK" name="nueNetoK" step="any" placeholder="INGRESAR PESO NETO kg" onchange="formula();" required>
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="number" class="form-control input-lg" id="netoQ" name="nueNetoQ" step="any" placeholder="INGRESAR PESO NETO qq" required>
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="number" class="form-control input-lg" id="netoT" name="nueNetoT" step="any" placeholder="INGRESAR PESO NETO TM" required>
          ...
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control input-lg" name="ediNegra" id="ediNegra" step="any" required>
