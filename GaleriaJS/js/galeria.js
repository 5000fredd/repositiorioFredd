...
=============================================*/
	...
	var mg  = {
		...
		lightbox: function(img){
			//el appendChild me permite trabajar con HTML y crear elementos en este caso el DIV siendoque tienen que se mayusculas
			...
			//outerHTML trae el contenido HTML
			...
			pg.modal.childNodes[1].style.border = "0px 0px 0px 5px";
